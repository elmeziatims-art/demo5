INSERT INTO AW_002_000002_000001
 ...
 SELECT COALESCE(MAX(OID),0)+1, '2027BUD_V1', 12, 'PIGIER_BOR', 'BAC_RH', 'B2', 'ALT', '2024',
...
INSERT INTO AW_002_000002_000001
 (OID, SCENARIO, PERIODE, ENTITY, PROGRAMME, AN_ETUDE, MODALITE, EXERCICE,
  ...
  REV_STUD, REV_FRAIS_INS, VOL_LEAD_ORG, VOL_LEAD_PAY, DEPENSE_ACQ, DEPENSE_MARQUE,
  USERUPD, DATEUPD, PROVENIENZA)
 SELECT COALESCE(MAX(OID),0)+1, '2027BUD_V1', 12, 'PIGIER_BOR', 'BAC_RH', 'B2', 'ALT', '2025',
...
INSERT INTO AW_002_000002_000001
 (OID, SCENARIO, PERIODE, ENTITY, PROGRAMME, AN_ETUDE, MODALITE, EXERCICE,
  ...
  REV_STUD, REV_FRAIS_INS, VOL_LEAD_ORG, VOL_LEAD_PAY, DEPENSE_ACQ, DEPENSE_MARQUE,
  USERUPD, DATEUPD, PROVENIENZA)
 SELECT COALESCE(MAX(OID),0)+1, '2027BUD_V1', 12, 'PIGIER_BOR', 'BAC_RH', 'B2', 'ALT', '2026',
...
INSERT INTO AW_002_000002_000001
 (OID, SCENARIO, PERIODE, ENTITY, PROGRAMME, AN_ETUDE, MODALITE, EXERCICE,
  ...
  REV_STUD, REV_FRAIS_INS, VOL_LEAD_ORG, VOL_LEAD_PAY, DEPENSE_ACQ, DEPENSE_MARQUE,
  USERUPD, DATEUPD, PROVENIENZA)
 SELECT COALESCE(MAX(OID),0)+1, '2027BUD_V1', 12, 'PIGIER_LYO', 'BAC_RH', 'B2', 'ALT', '2024',
...
INSERT INTO AW_002_000002_000001
 (OID, SCENARIO, PERIODE, ENTITY, PROGRAMME, AN_ETUDE, MODALITE, EXERCICE,
  ...
  REV_STUD, REV_FRAIS_INS, VOL_LEAD_ORG, VOL_LEAD_PAY, DEPENSE_ACQ, DEPENSE_MARQUE,
  USERUPD, DATEUPD, PROVENIENZA)
 SELECT COALESCE(MAX(OID),0)+1, '2027BUD_V1', 12, 'PIGIER_LYO', 'BAC_RH', 'B2', 'ALT', '2025',
...
INSERT INTO AW_002_000002_000001
 (OID, SCENARIO, PERIODE, ENTITY, PROGRAMME, AN_ETUDE, MODALITE, EXERCICE,
  ...
  REV_STUD, REV_FRAIS_INS, VOL_LEAD_ORG, VOL_LEAD_PAY, DEPENSE_ACQ, DEPENSE_MARQUE,
  USERUPD, DATEUPD, PROVENIENZA)
 SELECT COALESCE(MAX(OID),0)+1, '2027BUD_V1', 12, 'PIGIER_LYO', 'BAC_RH', 'B2', 'ALT', '2026',
